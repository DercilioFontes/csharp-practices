...
namespace Ch22Ex03Client
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IAppControlService client = ChannelFactory<IAppControlService>
                .CreateChannel(new NetTcpBinding(), new EndpointAddress("net.tcp://localhost:8081/AppControlService"));
